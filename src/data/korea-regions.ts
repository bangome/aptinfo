...
export const KOREA_REGIONS: Region[] = [
  ...
  {
    sido: '광주광역시',
    sigugun: ['광산구', '남구', '동구', '북구', '서구']
  },
  {
    sido: '대전광역시',
    sigugun: ['대덕구', '동구', '서구', '유성구', '중구']
  },
  {
    sido: '울산광역시',
    sigugun: ['남구', '동구', '북구', '울주군', '중구']
  },
  {
    sido: '세종특별자치시',
    sigugun: ['세종시']
...
export const getSidos = (): string[] => {
  return KOREA_REGIONS.map(region => region.sido);
};

export const getSiguguns = (sido: string): string[] => {
  const region = KOREA_REGIONS.find(r => r.sido === sido);
  return region ? region.sigugun : [];
};
